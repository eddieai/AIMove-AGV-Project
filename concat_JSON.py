...
print('Gesture Name, Gesture No. :\n', list(zip(gesture_list,range(1,len(gesture_list)+1)))) #  ('Blow_through_the_stick', 1), ('Tighten_the_base_of_the_glass_with_the_pliers', 2), ('New_Gesture4', 3)

with open('Keypoints_All.json', 'w') as outfile:
    json.dump(keypoints_all.to_json(orient='records'), outfile)